    ...
    >
      ...
      <div className="relative flex-shrink-0">
        <input
          ...
          className="w-6 h-6 rounded-[6px] cursor-pointer border border-border"
          style={{
            padding: 0,
            appearance: 'none',
      ...
      <input
        ...
        value={color}
        onChange={(e) => handleColorChange(index, e.target.value)}
        className="flex-1 min-w-0 h-8 px-2.5 rounded-md border border-border bg-input-background text-[13px]"
        placeholder="#000000"
      />
      <Button
